...
function () {
  ...
  AmplifyInput.prototype.componentWillLoad = function () {
    ...
    if (!Object(_helpers_80b400b1_js__WEBPACK_IMPORTED_MODULE_6__["e"])('amplify-authenticator', this.el)) return;
    this.removeHubListener = Object(_helpers_80b400b1_js__WEBPACK_IMPORTED_MODULE_6__["o"])(function () {
      /**
  ...
  AmplifyInput.prototype.componentDidLoad = function () {
    ...
    var container = Object(_helpers_80b400b1_js__WEBPACK_IMPORTED_MODULE_6__["e"])('amplify-auth-container', this.el);
    var signIn = Object(_helpers_80b400b1_js__WEBPACK_IMPORTED_MODULE_6__["e"])('amplify-sign-in', this.el); // only autocomplete if `amplify-auth-container` is present and input is under `sign-in`.
